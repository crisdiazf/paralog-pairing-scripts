...
rbm_paired = RBM(Potts((21, 111+174)), xReLU((add_h,)), zeros(21, 111+174, add_h))
if keeptrain 
...
base_name = "rbm_NULLpaired_PF00072_PF01339_q=200_fraction=$(fraction)_nadd=$(add_h)&k=$(k)&tt=$(ttf)&l2l1_weights=$(reg)_$(real)_learnrate0$(lrate)"
dir_results = joinpath(@__DIR__, "resultados/nomask/fixedscale")
