...
const N_GIBBS_STEPS_A       = 20
const N_GIBBS_STEPS_B       = 20
const N_GIBBS_STEPS_PAIRED  = 20
const CONVERGENCE_LOG_EVERY = 2    # log correlation trace every 10 checkpoints (every 1000 sweeps)
