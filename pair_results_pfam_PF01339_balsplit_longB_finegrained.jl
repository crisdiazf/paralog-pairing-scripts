...
const N_GIBBS_STEPS_A       = 80    # 2,000 sweeps -- fine-grained probe around the observed early peaks (~450-950 sweeps)
const N_GIBBS_STEPS_B       = 80
const N_GIBBS_STEPS_PAIRED  = 80
