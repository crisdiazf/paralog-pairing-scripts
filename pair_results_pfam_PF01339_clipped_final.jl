...
const N_GIBBS_STEPS_A       = 6     # 300 sweeps -- peak of the clipped-optimizer fine-grained probe (r_h=0.956,r_v=0.991,r_hv=0.942 @250-300)
const N_GIBBS_STEPS_B       = 4     # 200 sweeps -- peak of the clipped-optimizer fine-grained probe (r_h=0.908,r_v=0.988,r_hv=0.873 @150-250)
const N_GIBBS_STEPS_PAIRED  = 7     # 350 sweeps -- peak of the clipped-optimizer fine-grained probe (r_h=0.933,r_v=0.985,r_hv=0.919 @350)
