...
path="./.pfam/alignment_files/PF01339_filtered.fasta"
...
rbm = RBM(PottsGumbel((21, 174)), xReLU((nh,)), zeros(21, 174, nh))

initialize!(rbm, seqsB)
rbm = gpu(standardize(rbm))

base_name = "rbm_PF01339_k=$(k)&tt=$(tt)&l2l1_weights=$(reg)_learnrate04_nh=$(nh)"
