...
const N_GIBBS_STEPS_A       = 50
const N_GIBBS_STEPS_B       = 50
const N_GIBBS_STEPS_PAIRED  = 50
const CONVERGENCE_LOG_EVERY = 5    # log correlation trace every 10 checkpoints (every 1000 sweeps)
