...
const N_GIBBS_STEPS_A       = 160   # 8,000 sweeps -- fine-grained probe of the range where the
const N_GIBBS_STEPS_B       = 160   # coarse (500-sweep) convergence_check trace showed peaks:
const N_GIBBS_STEPS_PAIRED  = 160   # A/paired ~950-1450, B ~4450-6450 (much later than prior runs)
